    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          <h1 className="text-base font-semibold text-primary">Thank you!</h1>
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCobra believe that a phone case dosen't only need to
        ...
        <div>
            ...
            <div>
              ...
              <div className="mt-2 text-zinc-700">
                <address className="not-italic">
                  ...
                  <span className="block">
                    {billingAddress?.postalCode} {shippingAddress?.city}
                  </span>
                </address>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">DHL, takes up to 3 days</p>
            </div>
          </div>
        </div>
