...
import {
  ...
  MATERIALS,
  MODELS,
} from "@/app/validator/option-validator"
  ...
  const { mutate: saveConfig, isPending } = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description:
          "There was an error on our server. Please try again later.",
        variant: "destructive",
      });
    },
    onSuccess: () => {
  ...
  async function saveConfiguration() {
    ...
    try {
      ...
      await new Promise((resolve) => {
        ...
        userImage.onerror = (err) => console.error("Image failed to load", err);
      });
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] flex flex-col w-full col-span-full lg:col-span-1 bg-white">
        <ScrollArea className="relative flex-1 overflow-auto rounded-md">
          <div
            aria-hidden="true"
          ...
          <div className="px-8 pt-8 pb-12">
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                ...
                >
                  <Label>
                    Color: {options?.color?.label || "No color selected"}
                  </Label>
                    ...
                    <DropdownMenuContent align="end">
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex items-center gap-1 text-sm p-1.5 cursor-default hover:bg-zinc-100",
                            {
                              "bg-zinc-100":
